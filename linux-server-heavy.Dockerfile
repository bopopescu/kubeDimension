...
RUN apt-get install -y libqt4-dev libqt4-core libqt4-gui libqt4-network libqt4-* python-qt4 python-qt4-dev mlocate
...
RUN mkdir -p /src && \
    curl -O https://3230d63b5fc54e62148e-c95ac804525aac4b6dba79b00b39d1d3.ssl.cf1.rackcdn.com/Anaconda3-2.4.0-Linux-x86_64.sh && \
    chmod +x Anaconda3-2.4.0-Linux-x86_64.sh && \
    yes | ./Anaconda3-2.4.0-Linux-x86_64.sh 
