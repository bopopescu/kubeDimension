...
void protobuf_AddDesc_Header_2eproto() {
  ...
  ::hal::protobuf_AddDesc_CameraModel_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "(\0132\023.hal.CameraModelMsg", 143);
...
void Header::InitAsDefaultInstance() {
  camera_model_ = const_cast< ::hal::CameraModelMsg*>(&::hal::CameraModelMsg::default_instance());
}
...
void Header::MergeFrom(const Header& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_camera_model()) {
      mutable_camera_model()->::hal::CameraModelMsg::MergeFrom(from.camera_model());
    }
  }
