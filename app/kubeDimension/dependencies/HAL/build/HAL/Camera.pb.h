...
class CameraMsg : public ::google::protobuf::Message {
 public:
  ...
  inline const ::hal::ImageMsg& image(int index) const;
  inline ::hal::ImageMsg* mutable_image(int index);
  inline ::hal::ImageMsg* add_image();
  inline const ::google::protobuf::RepeatedPtrField< ::hal::ImageMsg >&
      image() const;
  inline ::google::protobuf::RepeatedPtrField< ::hal::ImageMsg >*
      mutable_image();
 ...
 private:
  ...
  double device_time_;
  ::google::protobuf::RepeatedPtrField< ::hal::ImageMsg > image_;
  double system_time_;
...
inline void CameraMsg::set_has_system_time() {
  _has_bits_[0] |= 0x00000008u;
}
inline void CameraMsg::clear_has_system_time() {
  _has_bits_[0] &= ~0x00000008u;
}
