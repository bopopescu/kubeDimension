...
void protobuf_AssignDesc_Pose_2eproto() {
  ...
  static const int PoseMsg_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PoseMsg, system_time_),
  };
  PoseMsg_reflection_ =
...
void protobuf_AddDesc_Pose_2eproto() {
  ...
  ::hal::protobuf_AddDesc_Matrix_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\nPose.proto\022\003hal\032\014Matrix.proto\"\362\001\n\007Pose"
    "Msg\022\n\n\002id\030\001 \001(\005\022\023\n\013device_time\030\002 \001(\001\022\037\n\004"
    "type\030\003 \002(\0162\021.hal.PoseMsg.Type\022\034\n\004pose\030\004 "
    "\001(\0132\016.hal.VectorMsg\022\"\n\ncovariance\030\005 \001(\0132"
    "\016.hal.MatrixMsg\022\023\n\013system_time\030\006 \001(\001\"N\n\004"
    "Type\022\007\n\003SO2\020\001\022\007\n\003SE2\020\002\022\007\n\003SO3\020\003\022\007\n\003SE3\020\004"
    "\022\016\n\nLatLongAlt\020\005\022\t\n\005Euler\020\006\022\007\n\003RAW\020\t", 276);
...
const int PoseMsg::kSystemTimeFieldNumber;
#endif  // !_MSC_VER
...
void PoseMsg::InitAsDefaultInstance() {
  pose_ = const_cast< ::hal::VectorMsg*>(&::hal::VectorMsg::default_instance());
  covariance_ = const_cast< ::hal::MatrixMsg*>(&::hal::MatrixMsg::default_instance());
}
...
void PoseMsg::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    type_ = 1;
    if (has_pose()) {
      if (pose_ != NULL) pose_->::hal::VectorMsg::Clear();
    }
    if (has_covariance()) {
      if (covariance_ != NULL) covariance_->::hal::MatrixMsg::Clear();
    }
    system_time_ = 0;
  }
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::hal::PoseMsg_Type_IsValid(value)) {
            set_type(static_cast< ::hal::PoseMsg_Type >(value));
          } else {
      ...
      case 5: {
        ...
        if (input->ExpectTag(49)) goto parse_system_time;
        break;
      }
...
void PoseMsg::SerializeWithCachedSizes(
  ...
  // optional double system_time = 6;
  if (has_system_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(6, this->system_time(), output);
  }
...
::google::protobuf::uint8* PoseMsg::SerializeWithCachedSizesToArray(
  ...
  // optional double system_time = 6;
  if (has_system_time()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(6, this->system_time(), target);
  }
...
void PoseMsg::MergeFrom(const PoseMsg& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_pose()) {
      mutable_pose()->::hal::VectorMsg::MergeFrom(from.pose());
    }
    if (from.has_covariance()) {
      mutable_covariance()->::hal::MatrixMsg::MergeFrom(from.covariance());
    }
