...
NOTE: 
  1.mapper and reducer are implemented in facecalmapper.cpp and facecalreducer.cpp respectively.
  2.hadoop_streaming.cpp contains base class for the mapper and reducer class.
