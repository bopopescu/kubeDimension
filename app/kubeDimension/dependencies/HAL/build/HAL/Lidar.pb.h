...
class LidarMsg : public ::google::protobuf::Message {
 public:
  ...
  inline const ::hal::MatrixMsg& distance() const;
  inline ::hal::MatrixMsg* mutable_distance();
  inline ::hal::MatrixMsg* release_distance();
  inline void set_allocated_distance(::hal::MatrixMsg* distance);
  ...
  inline const ::hal::MatrixMsg& intensity() const;
  inline ::hal::MatrixMsg* mutable_intensity();
  inline ::hal::MatrixMsg* release_intensity();
  inline void set_allocated_intensity(::hal::MatrixMsg* intensity);
  ...
  inline const ::hal::VectorMsg& rotational_position() const;
  inline ::hal::VectorMsg* mutable_rotational_position();
  inline ::hal::VectorMsg* release_rotational_position();
  inline void set_allocated_rotational_position(::hal::VectorMsg* rotational_position);
...
inline void LidarMsg::clear_distance() {
  if (distance_ != NULL) distance_->::hal::MatrixMsg::Clear();
  clear_has_distance();
}
...
inline ::hal::MatrixMsg* LidarMsg::mutable_distance() {
  set_has_distance();
  if (distance_ == NULL) distance_ = new ::hal::MatrixMsg;
  return distance_;
}
inline ::hal::MatrixMsg* LidarMsg::release_distance() {
  clear_has_distance();
  ::hal::MatrixMsg* temp = distance_;
  distance_ = NULL;
  return temp;
}
...
inline void LidarMsg::clear_intensity() {
  if (intensity_ != NULL) intensity_->::hal::MatrixMsg::Clear();
  clear_has_intensity();
}
...
inline ::hal::MatrixMsg* LidarMsg::mutable_intensity() {
  set_has_intensity();
  if (intensity_ == NULL) intensity_ = new ::hal::MatrixMsg;
  return intensity_;
}
inline ::hal::MatrixMsg* LidarMsg::release_intensity() {
  clear_has_intensity();
  ::hal::MatrixMsg* temp = intensity_;
  intensity_ = NULL;
  return temp;
}
...
inline void LidarMsg::clear_rotational_position() {
  if (rotational_position_ != NULL) rotational_position_->::hal::VectorMsg::Clear();
...
inline ::hal::VectorMsg* LidarMsg::mutable_rotational_position() {
  ...
  if (rotational_position_ == NULL) rotational_position_ = new ::hal::VectorMsg;
  return rotational_position_;
}
inline ::hal::VectorMsg* LidarMsg::release_rotational_position() {
  clear_has_rotational_position();
  ::hal::VectorMsg* temp = rotational_position_;
