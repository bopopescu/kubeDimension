...
class PoseMsg : public ::google::protobuf::Message {
 public:
  ...
  inline ::hal::PoseMsg_Type type() const;
  inline void set_type(::hal::PoseMsg_Type value);

  // optional .hal.VectorMsg pose = 4;
  inline bool has_pose() const;
  inline void clear_pose();
  static const int kPoseFieldNumber = 4;
  inline const ::hal::VectorMsg& pose() const;
  inline ::hal::VectorMsg* mutable_pose();
  inline ::hal::VectorMsg* release_pose();
  inline void set_allocated_pose(::hal::VectorMsg* pose);
  ...
  inline const ::hal::MatrixMsg& covariance() const;
  inline ::hal::MatrixMsg* mutable_covariance();
  inline ::hal::MatrixMsg* release_covariance();
  inline void set_allocated_covariance(::hal::MatrixMsg* covariance);

  // optional double system_time = 6;
  inline bool has_system_time() const;
  inline void clear_system_time();
  static const int kSystemTimeFieldNumber = 6;
...
inline ::hal::PoseMsg_Type PoseMsg::type() const {
  return static_cast< ::hal::PoseMsg_Type >(type_);
}
...
inline ::hal::VectorMsg* PoseMsg::mutable_pose() {
  set_has_pose();
  if (pose_ == NULL) pose_ = new ::hal::VectorMsg;
  return pose_;
}
inline ::hal::VectorMsg* PoseMsg::release_pose() {
  clear_has_pose();
  ::hal::VectorMsg* temp = pose_;
  pose_ = NULL;
  return temp;
}
...
inline ::hal::MatrixMsg* PoseMsg::mutable_covariance() {
  set_has_covariance();
  if (covariance_ == NULL) covariance_ = new ::hal::MatrixMsg;
  return covariance_;
}
inline ::hal::MatrixMsg* PoseMsg::release_covariance() {
  clear_has_covariance();
  ::hal::MatrixMsg* temp = covariance_;
  covariance_ = NULL;
  return temp;
}
...
inline void PoseMsg::set_has_system_time() {
  _has_bits_[0] |= 0x00000020u;
}
inline void PoseMsg::clear_has_system_time() {
  _has_bits_[0] &= ~0x00000020u;
}
