...
class ImageMsg : public ::google::protobuf::Message {
 public:
  ...
  inline ::hal::Type type() const;
  inline void set_type(::hal::Type value);

  // optional .hal.Format format = 5 [default = PB_RGB];
  inline bool has_format() const;
  inline void clear_format();
  static const int kFormatFieldNumber = 5;
  inline ::hal::Format format() const;
  inline void set_format(::hal::Format value);
  ...
  inline const ::hal::ImageInfoMsg& info() const;
  inline ::hal::ImageInfoMsg* mutable_info();
  inline ::hal::ImageInfoMsg* release_info();
  inline void set_allocated_info(::hal::ImageInfoMsg* info);
  ...
  inline ::google::protobuf::uint64 serial_number() const;
  inline void set_serial_number(::google::protobuf::uint64 value);
...
inline ::hal::Type ImageMsg::type() const {
  return static_cast< ::hal::Type >(type_);
}
...
inline ::hal::Format ImageMsg::format() const {
  return static_cast< ::hal::Format >(format_);
}
...
inline void ImageMsg::clear_info() {
  if (info_ != NULL) info_->::hal::ImageInfoMsg::Clear();
  clear_has_info();
}
...
inline ::hal::ImageInfoMsg* ImageMsg::mutable_info() {
  set_has_info();
  if (info_ == NULL) info_ = new ::hal::ImageInfoMsg;
  return info_;
}
inline ::hal::ImageInfoMsg* ImageMsg::release_info() {
  clear_has_info();
  ::hal::ImageInfoMsg* temp = info_;
  info_ = NULL;
  return temp;
}
...
inline void ImageMsg::set_has_serial_number() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ImageMsg::clear_has_serial_number() {
  _has_bits_[0] &= ~0x00000080u;
}
...
inline ::google::protobuf::uint64 ImageMsg::serial_number() const {
  return serial_number_;
}
inline void ImageMsg::set_serial_number(::google::protobuf::uint64 value) {
