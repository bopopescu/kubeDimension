...
void LidarMsg::InitAsDefaultInstance() {
  distance_ = const_cast< ::hal::MatrixMsg*>(&::hal::MatrixMsg::default_instance());
  intensity_ = const_cast< ::hal::MatrixMsg*>(&::hal::MatrixMsg::default_instance());
  rotational_position_ = const_cast< ::hal::VectorMsg*>(&::hal::VectorMsg::default_instance());
}
...
void LidarMsg::MergeFrom(const LidarMsg& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_distance()) {
      mutable_distance()->::hal::MatrixMsg::MergeFrom(from.distance());
    }
    if (from.has_intensity()) {
      mutable_intensity()->::hal::MatrixMsg::MergeFrom(from.intensity());
    }
    if (from.has_rotational_position()) {
      mutable_rotational_position()->::hal::VectorMsg::MergeFrom(from.rotational_position());
    }
  }
