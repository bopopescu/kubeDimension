...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/src/app/kubeDimension/tools/CMake-3.4.0/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/src/app/kubeDimension/tools/CMake-3.4.0/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/src/app/kubeDimension/tools/CMake-3.4.0/Utilities/Release\\CMakeInstall.bmp")
  ...
  set(CPACK_NSIS_PACKAGE_NAME "CMake 3.4.0")
  set(CPACK_NSIS_DISPLAY_NAME "CMake 3.4.0, a cross-platform, open-source build system")
...
include("/src/app/kubeDimension/tools/CMake-3.4.0/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/src/app/kubeDimension/tools/CMake-3.4.0/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/src/app/kubeDimension/tools/CMake-3.4.0/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright" "/src/app/kubeDimension/tools/CMake-3.4.0/Copyright.txt"
    )
  ...
  set(CPACK_IFW_COMPONENT_GROUP_TOOLS_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_CTEST_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_CPACK_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_CMAKEXBUILD_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_DIALOGS_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/src/app/kubeDimension/tools/CMake-3.4.0/Source/QtIFW/CMake.Dialogs.QtGUI.qs")
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_CCMAKE_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-MAN_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/src/app/kubeDimension/tools/CMake-3.4.0/CMake.Documentation.SphinxHTML.qs")
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_VERSION "3.4.0")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-QTHELP_VERSION "3.4.0")
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_PACKAGE_FILE_NAME
    "${CPACK_PACKAGE_NAME}-3.4.0-${CPACK_SYSTEM_NAME}")
  set(CPACK_SOURCE_PACKAGE_FILE_NAME
    "${CPACK_PACKAGE_NAME}-3.4.0-Source")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/src/app/kubeDimension/tools/CMake-3.4.0/Utilities/Release/CMakeLogo.ico"
  )
  ...
  set(CPACK_WIX_UI_BANNER
    "/src/app/kubeDimension/tools/CMake-3.4.0/Utilities/Release/cpack_wix_ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/src/app/kubeDimension/tools/CMake-3.4.0/Utilities/Release/cpack_wix_ui_dialog.jpg"
  )
endif()
