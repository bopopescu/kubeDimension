...
void protobuf_AssignDesc_Camera_2eproto() {
  ...
  static const int CameraMsg_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CameraMsg, system_time_),
  };
...
void protobuf_AddDesc_Camera_2eproto() {
  ...
  ::hal::protobuf_AddDesc_Image_2eproto();
...
const int CameraMsg::kSystemTimeFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(26)) goto parse_image;
        if (input->ExpectTag(33)) goto parse_system_time;
        break;
      }
...
void CameraMsg::SerializeWithCachedSizes(
  ...
  // optional double system_time = 4;
  if (has_system_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(4, this->system_time(), output);
  }
...
::google::protobuf::uint8* CameraMsg::SerializeWithCachedSizesToArray(
  ...
  // optional double system_time = 4;
  if (has_system_time()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(4, this->system_time(), target);
  }
