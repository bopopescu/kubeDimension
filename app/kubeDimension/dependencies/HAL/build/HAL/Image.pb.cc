...
void protobuf_AssignDesc_Image_2eproto() {
  ...
  static const int ImageMsg_offsets_[8] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ImageMsg, serial_number_),
  };
...
const int ImageMsg::kSerialNumberFieldNumber;
#endif  // !_MSC_VER
...
void ImageMsg::InitAsDefaultInstance() {
  info_ = const_cast< ::hal::ImageInfoMsg*>(&::hal::ImageInfoMsg::default_instance());
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::hal::Type_IsValid(value)) {
            set_type(static_cast< ::hal::Type >(value));
          } else {
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_format:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::hal::Format_IsValid(value)) {
            set_format(static_cast< ::hal::Format >(value));
          } else {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_serial_number;
        break;
      }
...
void ImageMsg::SerializeWithCachedSizes(
  ...
  if (has_serial_number()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(8, this->serial_number(), output);
  }
...
::google::protobuf::uint8* ImageMsg::SerializeWithCachedSizesToArray(
  ...
  // optional uint64 serial_number = 8;
  if (has_serial_number()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(8, this->serial_number(), target);
  }
...
void ImageMsg::MergeFrom(const ImageMsg& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_info()) {
      mutable_info()->::hal::ImageInfoMsg::MergeFrom(from.info());
    }
