...
class VehicleMsg : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:hal.VehicleMsg)
 private:
...
class RegisterControllerReqMsg : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:hal.RegisterControllerReqMsg)
 private:
...
class RegisterControllerRepMsg : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:hal.RegisterControllerRepMsg)
 private:
