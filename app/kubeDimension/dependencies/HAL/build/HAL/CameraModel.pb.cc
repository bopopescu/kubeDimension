...
void CameraModelMsg::InitAsDefaultInstance() {
  pose_local_camera_ = const_cast< ::hal::PoseMsg*>(&::hal::PoseMsg::default_instance());
  params_ = const_cast< ::hal::VectorMsg*>(&::hal::VectorMsg::default_instance());
}
...
void CameraModelMsg::MergeFrom(const CameraModelMsg& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_pose_local_camera()) {
      mutable_pose_local_camera()->::hal::PoseMsg::MergeFrom(from.pose_local_camera());
    }
    if (from.has_params()) {
      mutable_params()->::hal::VectorMsg::MergeFrom(from.params());
    }
  }
