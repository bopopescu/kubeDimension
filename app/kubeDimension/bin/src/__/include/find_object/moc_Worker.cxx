...
#include "../../../../../include/find_object/Worker.h"
...
static const char qt_meta_stringdata_Worker[] = {
    "Worker\0\0socketDescriptor\0newConnection(int)\0"
    "onNewConnection(int)\0onRequestReady()\0"
    "onUpgrade(QByteArray)\0"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onNewConnection((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->onRequestReady(); break;
        case 3: _t->onUpgrade((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Worker::newConnection(int _t1)
{
