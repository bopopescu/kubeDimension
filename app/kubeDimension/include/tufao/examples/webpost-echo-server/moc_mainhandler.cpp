...
static const char qt_meta_stringdata_MainHandler[] = {
    "MainHandler\0\0request,response\0"
...
void MainHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->handleRequest((*reinterpret_cast< Tufao::HttpServerRequest*(*)>(_a[1])),(*reinterpret_cast< Tufao::HttpServerResponse*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject MainHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MainHandler,
