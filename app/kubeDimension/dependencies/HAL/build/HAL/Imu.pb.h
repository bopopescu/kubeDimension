...
class ImuMsg : public ::google::protobuf::Message {
 public:
  ...
  inline const ::hal::VectorMsg& accel() const;
  inline ::hal::VectorMsg* mutable_accel();
  inline ::hal::VectorMsg* release_accel();
  inline void set_allocated_accel(::hal::VectorMsg* accel);

  // optional .hal.VectorMsg gyro = 5;
  inline bool has_gyro() const;
  inline void clear_gyro();
  static const int kGyroFieldNumber = 5;
  inline const ::hal::VectorMsg& gyro() const;
  inline ::hal::VectorMsg* mutable_gyro();
  inline ::hal::VectorMsg* release_gyro();
  inline void set_allocated_gyro(::hal::VectorMsg* gyro);

  // optional .hal.VectorMsg mag = 6;
  inline bool has_mag() const;
  inline void clear_mag();
  static const int kMagFieldNumber = 6;
  inline const ::hal::VectorMsg& mag() const;
  inline ::hal::VectorMsg* mutable_mag();
  inline ::hal::VectorMsg* release_mag();
  inline void set_allocated_mag(::hal::VectorMsg* mag);
...
inline void ImuMsg::clear_accel() {
  if (accel_ != NULL) accel_->::hal::VectorMsg::Clear();
  clear_has_accel();
}
...
inline ::hal::VectorMsg* ImuMsg::mutable_accel() {
  set_has_accel();
  if (accel_ == NULL) accel_ = new ::hal::VectorMsg;
  return accel_;
}
inline ::hal::VectorMsg* ImuMsg::release_accel() {
  clear_has_accel();
  ::hal::VectorMsg* temp = accel_;
  accel_ = NULL;
  return temp;
}
...
inline void ImuMsg::clear_gyro() {
  if (gyro_ != NULL) gyro_->::hal::VectorMsg::Clear();
  clear_has_gyro();
}
...
inline ::hal::VectorMsg* ImuMsg::mutable_gyro() {
  set_has_gyro();
  if (gyro_ == NULL) gyro_ = new ::hal::VectorMsg;
  return gyro_;
}
inline ::hal::VectorMsg* ImuMsg::release_gyro() {
  clear_has_gyro();
  ::hal::VectorMsg* temp = gyro_;
  gyro_ = NULL;
  return temp;
}
...
inline void ImuMsg::clear_mag() {
  if (mag_ != NULL) mag_->::hal::VectorMsg::Clear();
  clear_has_mag();
}
...
inline ::hal::VectorMsg* ImuMsg::mutable_mag() {
  set_has_mag();
  if (mag_ == NULL) mag_ = new ::hal::VectorMsg;
  return mag_;
}
inline ::hal::VectorMsg* ImuMsg::release_mag() {
  clear_has_mag();
  ::hal::VectorMsg* temp = mag_;
  mag_ = NULL;
  return temp;
}
