...
public:
	FindObject(bool keepImagesInRAM_ = true, bool distributedSearch_ = false, int workersCopy_ = 1, int workersShards_ = 1, QObject * parent = 0);
	virtual ~FindObject();
	...
	int loadObjects(const QString & dirPath, bool recursive); // call updateObjects()
