...
class CameraModelMsg : public ::google::protobuf::Message {
 public:
  ...
  inline const ::hal::PoseMsg& pose_local_camera() const;
  inline ::hal::PoseMsg* mutable_pose_local_camera();
  inline ::hal::PoseMsg* release_pose_local_camera();
  inline void set_allocated_pose_local_camera(::hal::PoseMsg* pose_local_camera);

  // optional .hal.VectorMsg params = 8;
  inline bool has_params() const;
  inline void clear_params();
  static const int kParamsFieldNumber = 8;
  inline const ::hal::VectorMsg& params() const;
  inline ::hal::VectorMsg* mutable_params();
  inline ::hal::VectorMsg* release_params();
  inline void set_allocated_params(::hal::VectorMsg* params);
...
inline void CameraModelMsg::clear_pose_local_camera() {
  if (pose_local_camera_ != NULL) pose_local_camera_->::hal::PoseMsg::Clear();
...
inline ::hal::PoseMsg* CameraModelMsg::mutable_pose_local_camera() {
  ...
  if (pose_local_camera_ == NULL) pose_local_camera_ = new ::hal::PoseMsg;
  return pose_local_camera_;
}
inline ::hal::PoseMsg* CameraModelMsg::release_pose_local_camera() {
  clear_has_pose_local_camera();
  ::hal::PoseMsg* temp = pose_local_camera_;
...
inline void CameraModelMsg::clear_params() {
  if (params_ != NULL) params_->::hal::VectorMsg::Clear();
  clear_has_params();
}
...
inline ::hal::VectorMsg* CameraModelMsg::mutable_params() {
  set_has_params();
  if (params_ == NULL) params_ = new ::hal::VectorMsg;
  return params_;
}
inline ::hal::VectorMsg* CameraModelMsg::release_params() {
  clear_has_params();
  ::hal::VectorMsg* temp = params_;
  params_ = NULL;
  return temp;
}
