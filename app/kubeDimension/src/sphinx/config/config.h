...
#define COMPILER "gcc 4.9.3"

/* Flags used to configure me */
#define CONFIGURE_FLAGS ""

/* Define to 1 if you want runtime load libexpat using dlopen */
#define DL_EXPAT 0

/* Define to 1 if you want runtime load mysql using dlopen */
#define DL_MYSQL 0
...
/* Full name OS */
#define OS_UNAME "Linux 1bed67c229f5 4.2.2-coreos #2 SMP Fri Oct 16 04:19:33 UTC 2015 x86_64 x86_64 x86_64 GNU/Linux"
...
#define PACKAGE_STRING "sphinx 2.2.8"
